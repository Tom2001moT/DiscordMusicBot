...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const InstagramLink = 'https://www.instagram.com/_white_death_gaming_/#';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/2TDD89cxwS'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ Myself Tom aka WDG. I am a discord bot developer and web developer. I love playing games, watching Movies and building different webserver applications. You will get faster replies on instagram than other social media. Feel free to contact me!\n YouTube : ❤️ [WhiteDeath_WDG_](${youtubeLink})\n Instagram : 💙 [_White_Death_Gaming_](${InstagramLink})`)
            .setTimestamp();
